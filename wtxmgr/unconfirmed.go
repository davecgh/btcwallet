...
func (u *unconfirmedStore) lookupTxRecord(hash *btcwire.ShaHash) (*txRecord,
	error) {
	var record *txRecord
	err := u.namespace.View(func(wtx walletdb.Tx) error {
		var err error
...
func (u *unconfirmedStore) deleteSpentBlockOutpoint(op *btcwire.OutPoint,
...
func (u *unconfirmedStore) setPrevOutPointSpender(op *btcwire.OutPoint,
	r *txRecord) error {
	return u.namespace.Update(func(wtx walletdb.Tx) error {
...
func (u *unconfirmedStore) fetchPrevOutPointSpender(op *btcwire.OutPoint) (
	*txRecord, error) {
	var record *txRecord
	err := u.namespace.View(func(wtx walletdb.Tx) error {
		var err error
...
// the given outpoint.
func (u *unconfirmedStore) lookupSpentBlockOutPointKey(op *btcwire.OutPoint) (
...
// given spender.
func (u *unconfirmedStore) setOutPointSpender(op *btcwire.OutPoint,
	r *txRecord) error {
	return u.namespace.Update(func(wtx walletdb.Tx) error {
...
// spender.
func (u *unconfirmedStore) setBlockOutPointSpender(op *btcwire.OutPoint,
